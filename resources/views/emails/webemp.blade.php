...
<head>
  ...
  <title>Bolsa De Trabajo ITTG</title>
  <style type="text/css">
...
<tr>
  <td>    
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td bgcolor="##636b6f" class="header">
          <table width="70" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td bgcolor="#ffffff">
                <img  style="float: left; margin-right: 5px;" src="https://sites.google.com/site/ittgcresudlaconcordia/_/rsrc/1509162146005/home/images.png" alt="" width="80" height="20" alt="">
              </td>
            </tr>
          </table>
          <table width="70" align="right" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td>
                <img  style="float: left; margin-right: 5px;" src="http://photos1.blogger.com/blogger/4856/1573/1600/LOGO1.2.gif" alt="" width="60" height="40" alt="">
              </td>
            </tr>
          </table>
                                                                ...
                                                                <tr>
                                                                    <td width="174" class="es-m-p0r es-m-p20b esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                  <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img src="https://sites.google.com/site/ittgcresudlaconcordia/_/rsrc/1509162146005/home/images.png" alt style="display: block;" width="139"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">
                                                                                        <p style="color: #ffffff; font-size: 12px;"><strong>Tecnológico Nacional de México<br>Campus Tuxtla Gutiérrez<br>Bolsa De Trabajo</strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td width="173" align="center" class="esd-container-frame">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                  <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img src="http://photos1.blogger.com/blogger/4856/1573/1600/LOGO1.2.gif" alt style="display: block;" width="82"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p40r es-p40l" align="center">
                                                                                        <p> Alguien se ha postulado a tu solicitud, ingresa a tu sesión para verla.
                                                                                          </p>
                                                                                          <a href="{{$data1}}">click aquí</a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text">
                                                                                        <p style="font-size: 8px;">Carretera&nbsp;Panamericana&nbsp;Km.&nbsp;1080.<br>C.&nbsp;P.&nbsp;29050,&nbsp;Apartado&nbsp;Postal&nbsp;599.<br>Tuxtla&nbsp;Gutiérrez,&nbsp;Chiapas.<br>Tels.&nbsp;(961)&nbsp;61&nbsp;50380,&nbsp;61&nbsp;50461;&nbsp;Ext.&nbsp;101</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
