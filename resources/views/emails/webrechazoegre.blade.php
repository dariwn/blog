                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p40r es-p40l" align="center">
                                                                                        <p>El administrador del sistema a rechazado tu registro. Si deseas saber más contactate con el al siguiente correo: {{ $data1 }}, o revisa en el siguiente link {{ $data }} , si tus datos son correctos, si alguno de tus datos esta mal corrigelo y en breve el administrador del sistema volvera a verificar tu información.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
