...
<div class="row">
    ...
    @csrf
            ...
            <div class="row">
                ...
                <input type="text" name="correo" required value="{{ $datos->email }}" class="form-control" placeholder="Correo..." readonly>
                </div>
                </div>
                <div class="col-lg-6 ">
                <div class="form-group">
                <label for="codigo">Nombres</label>
                <input type="text" name="nombres" id="nombres" required value="{{ $datos->nombres }}" class="form-control" placeholder="Nombres...">
                </div>  
                </div>
                ...
                <input type="text" name="apellido_paterno" id="apellidos" required value="{{ $datos->apellido_paterno }}" class="form-control" placeholder="Apellido Paterno...">
                </div>  
                </div>
                ...
                <input type="text" name="apellido_materno" id="apellidos" required value="{{ $datos->apellido_materno }}" class="form-control" placeholder="Apellido Materno">
                </div>  
                </div>
