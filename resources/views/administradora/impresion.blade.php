...
<head>
	<title></title>
	<img HSPACE="10" VSPACE="10" src=" {{asset('img/educacion.png')}}" width="350" height="100" align="left">
	<img HSPACE="10" VSPACE="10" src="{{asset('img/tecnm.png')}}" width="250" height="100">
</head>
<body>
	...
	<footer class="footer">
		<hr>
		<img src="{{asset('img/logo.png')}}" width="40" align="left">
		<img src="{{asset('img/gestion.jpeg')}}"  width="40" align="right">
		<img src="{{asset('img/compact.jpg')}}" width="40" align="right">
