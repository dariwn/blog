...
class NuevoController extends Controller
{
    ...
    public function descargar_reporte(Request $request)
    {
       ...
       // dd($hasta);
        ...
        // $empresa = $empresa->where('created_at', '<', $hasta);
        // $egresado = Egresado::where('created_at', '>=', $periodo);
        // $egresado = $egresado->where('created_at', '<', $hasta);
        // $solicitud = Solicitudperfil::where('created_at', '>=', $periodo);
        // $solicitud = $solicitud->where('created_at', '<', $hasta);
        //$egresado = User::select('created_at')->where('origen','=','Egresado','AND','created_at', '>',$periodo, 'AND','created_at', '<=', $hasta )->count();
        //dd($conteg);
